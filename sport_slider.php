...
.img-fluid {
    ...
    <h3 style="font-weight: bold; font-style: italic;">RUN FOR THE OCEANS COLLECTION</h3>
    <div class="row mx-auto my-auto justify-content-center">
        <div id="recipeCarousel" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-caption">
            ...
            <p class="text-start"><span class="badge bg-light text-dark"  style="    color: #fff; font-weight: 300 !important;
  font-size: 15px;">$180 </span></p>
          </div>
        </div>
                        </div>
