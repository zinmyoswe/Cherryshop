...
.badge{
   ...
   <div class="container " style="max-width: 1280px;">
   		...
   		<a href="product.php">Home</a> / <a href="product.php">Mens</a> / Hoodies + Sweatshirts

   		<div class="header-wrapper___3fLbE">
   			<div class="row">
          <div class="col-9">
   				<h1 class="heading___1_p74" data-auto-id="plp-header-bar-breadcrumb"><span>HOODIES + SWEATSHIRTS</span><div class="count___1ZIhY" data-auto-id="plp-header-bar-products-count">[722]
   			</div></h1>
   				&nbsp;
   			</div>
        <div class="col-3">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  <div class="offcanvas-header">
    <h5 id="offcanvasRightLabel">Filter & Sort</h5>
